from src.schemas import UserInDB, FileInDB, hash_password

users_db = {
    "alice": UserInDB(
        username="alice", role="user", password=hash_password("alice123")
    ),  # nosec
    "bob": UserInDB(
        username="bob", role="user", password=hash_password("bob123")
    ),  # nosec
    "admin": UserInDB(
        username="admin", role="admin", password=hash_password("admin123")
    ),  # nosec
}
